...
const UetdsAirportSchema = new mongoose.Schema(
    {
        code: {
            type: Number,
    ...
    { collection: 'uetdsairports' }
);

UetdsAirportSchema.plugin(mongoosePaginate);


module.exports = mongoose.model('UetdsAirport', UetdsAirportSchema);